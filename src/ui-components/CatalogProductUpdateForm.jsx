...
export default function CatalogProductUpdateForm(props) {
  const {
    id,
    catalogProduct,
    onSuccess,
  ...
  const resetStateValues = () => {
    const cleanValues = { ...initialValues, ...catalogProductRecord };
  ...
  const [catalogProductRecord, setCatalogProductRecord] =
    React.useState(catalogProduct);
  React.useEffect(() => {
    const queryData = async () => {
      const record = id
        ? await DataStore.query(CatalogProduct, id)
        : catalogProduct;
      setCatalogProductRecord(record);
    };
    queryData();
  }, [id, catalogProduct]);
  React.useEffect(resetStateValues, [catalogProductRecord]);
  const validations = {
    name: [],
    image_url: [],
    price: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          await DataStore.save(
            CatalogProduct.copyOf(catalogProductRecord, (updated) => {
      ...
      {...rest}
      {...getOverrideProps(overrides, "CatalogProductUpdateForm")}
    >
      <TextField
        label="Name"
        isRequired={false}
