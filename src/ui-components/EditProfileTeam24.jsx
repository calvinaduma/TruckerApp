...
export default function EditProfileTeam24(props) {
  ...
  const textFieldTwoNineSevenSixSixNineTwoTwoOnChange =
    useDataStoreUpdateAction({
      fields: {
        nam: textFieldTwoNineSevenSixSixNineTwoTwoValue,
        phone_number: textFieldTwoNineSevenSixSixNineTwoThreeValue,
      ...
      >
        ...
        >
          <TextField
            ...
            onChange={() => {
              textFieldTwoNineSevenSixSixNineTwoTwoOnChange();
            }}
            onChange={(event) => {
